...
def mentionMembers(to, mid):
    try:
        arrData = ""
        textx = f"Mention members ({len(mid)})\n"
        arr = []
        no = 1
        num = 2
        for i in mid:
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    names = [contact.mid for contact in gid.members]
                    nm1, nm2, nm3, nm4, jml = [], [], [], [], len(names)
                    if jml <= 20:
                        mentionMembers(to, names)
                    if jml > 20 and jml < 40:
                        for i in range (0, 20):
                            nm1 += [names[i]]
                        mentionMembers(to, nm1)
                        for j in range (20, len(names)-1):
                            nm2 += [names[j]]
                        mentionMembers(to, nm2)
                    if jml > 40 and jml < 60:
                        ...
                        for j in range (20, 40):
                            nm2 += [names[j]]
                        mentionMembers(to, nm2)
                        for k in range (40, len(names)-1):
                            nm3 += [names[k]]
                        mentionMembers(to, nm3)
                    if jml > 60 and jml < 80:
                        ...
                        for k in range (40, 60):
                            nm3 += [names[k]]
                        mentionMembers(to, nm3)
                        for l in range (80, len(names)-1):
                            nm4 += [names[l]]
                        mentionMembers(to, nm4)
